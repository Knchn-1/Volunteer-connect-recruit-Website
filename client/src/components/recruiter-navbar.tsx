...
export function RecruiterNavbar() {
  ...
  const navLinks = [
    ...
    { path: "/recruiter/suggestions", label: "Suggestions" },
    { path: "/recruiter/opportunities", label: "Opportunities" },
        ...
        <div className="flex justify-between h-16">
          <div className="flex">
            <div className="flex-shrink-0 flex items-center">
              <Link href="/">
                <span className="text-secondary text-xl font-bold cursor-pointer">VolunteerConnect</span>
              </Link>
            </div>
              ...
              {navLinks.map((link) => (
                <Link key={link.path} href={link.path}>
                  <a
                    className={`${
                      location === link.path
                        ? "border-secondary text-neutral-700"
                        : "border-transparent text-neutral-500 hover:border-secondary hover:text-neutral-700"
          ...
          <div className="hidden sm:ml-6 sm:flex sm:items-center">
            {user ? (
              ...
              <>
                ...
                <Link href="/auth">
                  <Button className="ml-3 bg-secondary hover:bg-secondary-dark text-white">
                    Sign up
                  </Button>
                </Link>
              </>
              ...
              <a
                ...
                className={`${
                  location === link.path
                    ...
                    : "border-transparent text-neutral-600 hover:bg-neutral-100 hover:border-secondary-light hover:text-neutral-800"
          ...
          <div className="flex items-center justify-between mt-4 px-3">
            {user ? (
              ...
              <>
                ...
                <Link href="/auth">
                  <Button onClick={closeMobileMenu} className="w-1/2 bg-secondary hover:bg-secondary-dark">
                    Sign up
                  </Button>
                </Link>
              </>
